...
if ( NOT DEFINED OPENSSL_ROOT_DIR )
  if (WIN32)
    ...
    get_filename_component ( BASEDIR "/usr/local/openssl/" REALPATH )
  endif()
...
if ( OPENSSL_ROOT_DIR )
    ...
    if (WIN32)
       ...
       set ( OPENSSL_LIB_DIR "${OPENSSL_ROOT_DIR}/" CACHE PATH "Path to libraries" FORCE)	
    endif()
    ...
    unset ( LIST_DLL )	
    unset ( LIST_LIB )	
	_FIND_FILE ( LIST_DLL OPENSSL_LIB_DIR "libssl-1_1-x64.dll" "" OK_DLL )	
	_FIND_FILE ( LIST_DLL OPENSSL_LIB_DIR "libcrypto-1_1-x64.dll" "" OK_DLL )	

  	_FIND_FILE ( LIST_LIB OPENSSL_LIB_DIR "libssl.lib" "libssl.so" OK_LIB )
  	_FIND_FILE ( LIST_LIB OPENSSL_LIB_DIR "libcrypto.lib" "libcrypto.so" OK_LIB )
